...
e.preventDefault();
const income = { id: Date.now(), amount: parseFloat(amount), source, date, note };
saveIncome(income);
onAdd(income);
setAmount('');
setSource('Salary');
...
<button type="submit" className="bg-green-600 text-white px-4 py-2 rounded w-full">Add Income</button>
</form>
);
}